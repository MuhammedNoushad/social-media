...
const ProfileCard: React.FC = () => {
  ...
  return (
    <div className="relative w-auto min-w-0 mb-6 break-words border border-dashed bg-clip-border rounded-2xl border-stone-200 bg-light/30 draggable max-h-[33vh] ">
      {/* card body */}
